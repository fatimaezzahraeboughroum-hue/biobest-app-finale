...
# --- 2. CONNEXION (VERSION CORRIGÉE) ---
@st.cache_resource
def connecter_google():
    try:
        # SI on est sur Internet (Streamlit Cloud)
        ...
        # SINON, on utilise le fichier local sur ton PC (pour tes tests)
        else:
            gc = gspread.service_account(filename='creds.json')

        # Connexion à ton Google Sheet spécifique
